...
function register({ config: { rows, cols, autoPlay, ...unknownOptions } }) {
  // console.log("xxx config2", rows)
  // console.log("xxx config3", unknownOptions)
...
// function processAsciinemaBlock(context) {
//   // console.log("xxx")
